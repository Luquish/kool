      ...
      <main>
        ...
        <section className="py-20 relative overflow-hidden bg-cream h-screen">
          <div className="absolute top-0 left-0 w-full h-full">
            <div className="absolute top-20 left-20 w-40 h-40 bg-orange-500 opacity-5 rounded-full"></div>
            <div className="absolute bottom-40 right-20 w-60 h-60 bg-navy-blue opacity-5 rounded-full"></div>
            <div className="absolute top-40 right-40 w-20 h-20 bg-mustard opacity-10 rounded-full"></div>
          </div>

          <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
            <div className="text-center mb-12">
              <h2 className="inline-block text-5xl md:text-6xl font-bold pb-2 heading-display">
                YOUR <span className="text-navy-blue">DIGITAL</span> MANAGER
              </h2>
              <p className="mt-6 text-xl text-gray-700 max-w-2xl mx-auto">
                <span className="kool-brand">KOOL</span> works like your personal manager, but powered by AI. Get advice, strategies, and tools to grow your
                music career.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-1">
              <div className="bg-gradient-to-b from-orange-500 to-orange-600 p-6 rounded-lg text-white flex flex-col overflow-hidden">
                <div className="flex items-center gap-4 mb-4">
                  <Zap className="w-8 h-8" />
                  <h3 className="text-2xl font-bold heading-display">AI STRATEGY</h3>
                </div>
                <div className="relative mb-4 flex-1">
                  <Image 
                    src="/images/AI STRATEGY.png" 
                    alt="AI Strategy" 
                    width={400} 
                    height={300}
                ...
                <p className="mb-2">Get personalized career strategies based on your music style, goals, and audience.</p>
              </div>
              
              <div className="bg-gradient-to-b from-navy-blue to-blue-900 p-6 rounded-lg text-white flex flex-col overflow-hidden">
                <div className="flex items-center gap-4 mb-4">
                  <Music className="w-8 h-8" />
                  <h3 className="text-2xl font-bold heading-display">DISTRIBUTION TOOLS</h3>
                </div>
                <div className="relative mb-4 flex-1">
                  <Image 
                    src="/images/DISTRIBUTION TOOLS.png" 
                ...
                <p className="mb-2">Release your music to all major platforms with just a few clicks.</p>
              </div>
              
              <div className="bg-gradient-to-b from-mustard to-yellow-700 p-6 rounded-lg flex flex-col overflow-hidden">
                <div className="flex items-center gap-4 mb-4">
                  <Headphones className="w-8 h-8" />
                  <h3 className="text-2xl font-bold heading-display">AUDIENCE GROWTH</h3>
                </div>
                <div className="relative mb-4 flex-1">
                  <Image 
                    src="/images/AUDIENCE GROWTH.png" 
                    alt="Audience Growth" 
                    width={400} 
                    height={300}
                    className="object-contain w-full h-full rounded-md"
                ...
                <p className="mb-2">Discover how to grow your fanbase with data-driven recommendations.</p>
              </div>
            </div>
          </div>
        </section>
